...
class Utilisateur {
    ...
    static ajoutuser(nom, courriel, motDePasse){
        ...
        return new Promise((resolve, reject) => {
            ...
            .then(hash => {
                const requete = `INSERT INTO utilisateur (nom, courriel, mot_de_passe, cle_api) VALUES ($1, $2, $3, $4);`;
    ...
    static verifierCle(cleApi) {
        return new Promise((resolve, reject) => {
            const requete = `SELECT COUNT(*) AS nbUsagers FROM utilisateur WHERE cle_api = $1;`;
            const params = [cleApi];
    ...
    static verifieCourriel(courriel){
        return new Promise((resolve, reject) => {
            ...
            const requete = `SELECT COUNT(*) AS nbUsagers FROM utilisateur WHERE courriel = $1;`;
        ...
        return new Promise((resolve, reject) => {
            if (nouvelle === 1) {
                ...
                bcrypt.hash(motDePasse, costFactor)
                    .then(hash => {
                        const updateQuery = `UPDATE utilisateur SET cle_api = $1 WHERE courriel = $2 AND mot_de_passe = $3;`;
                ...
                const selectQuery = `SELECT cle_api, mot_de_passe FROM utilisateur WHERE courriel = $1;`;
